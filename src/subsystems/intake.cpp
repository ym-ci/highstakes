...
Intake::Intake() : elevated(false), stopPosition(0), lastWrongRingTime(0), filterState(true) {
}
...
bool Intake::getFilterState() { return filterState; }

void Intake::setFilterState(bool state) { filterState = state; }
